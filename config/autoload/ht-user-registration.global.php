...
$options = array(
    ...
    'email_from_address' => array(
        'no-reply@klevo.com.ua' => 'Confirmation of registration',
    ),
     ...
     *
     */
    'verification_email_subject' => 'Подтверждение email адреса',
    /**
     * Subject of Password request email
     *
     */
    'password_request_email_subject' => 'Установка пароля',
...
$zfcSettings = array(
    'auth_adapters' => array(80 => 'HtUserRegistration\Authentication\Adapter\EmailVerification'),
);
