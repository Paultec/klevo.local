 ...
 */
class DeliveryMethod extends \Data\Entity\DeliveryMethod implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Data\\Entity\\DeliveryMethod' . "\0" . 'id', '' . "\0" . 'Data\\Entity\\DeliveryMethod' . "\0" . 'name', '' . "\0" . 'Data\\Entity\\DeliveryMethod' . "\0" . 'idStatus');
        }
