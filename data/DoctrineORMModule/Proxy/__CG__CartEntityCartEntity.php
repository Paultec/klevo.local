...
namespace DoctrineORMModule\Proxy\__CG__\Cart\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class CartEntity extends \Cart\Entity\CartEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cart\\Entity\\CartEntity' . "\0" . 'id', '' . "\0" . 'Cart\\Entity\\CartEntity' . "\0" . 'date', '' . "\0" . 'Cart\\Entity\\CartEntity' . "\0" . 'comment', '' . "\0" . 'Cart\\Entity\\CartEntity' . "\0" . 'type', '' . "\0" . 'Cart\\Entity\\CartEntity' . "\0" . 'deliveryMethod', '' . "\0" . 'Cart\\Entity\\CartEntity' . "\0" . 'paymentMethod', '' . "\0" . 'Cart\\Entity\\CartEntity' . "\0" . 'idUser', '' . "\0" . 'Cart\\Entity\\CartEntity' . "\0" . 'idStatus');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CartEntity $proxy) {
